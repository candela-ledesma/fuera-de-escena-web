  ...
  return (
    <div className="grid grid-cols-2 gap-2 sm:grid-cols-4 sm:gap-4">
      ...
      <Card className="gap-1 p-4 sm:p-6">
        ...
        <span className="font-display text-3xl text-foreground sm:text-4xl mt-1">{totalViews}</span>
      </Card>
